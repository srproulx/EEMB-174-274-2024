...
Based on this summary of the posterior, do you think this model is able to predict anything? 
...
Summarise the simulation data and join it to the original dataset.
