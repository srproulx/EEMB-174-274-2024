...
In addition to the fact that WAIC suggests m7.5 is an improvement, we can ask if m7.5 shows different slopes depending on continents. We can see this by taking the contrast bertween the slopes, and see that they do differ.
```{r}
